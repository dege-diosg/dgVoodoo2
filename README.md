...
You can easily do the graphics part of the porting with 64 bit dgVoodoo graphics API dlls that
you can freely ship with your application.  
In the first step you can port it to plain x64 to see if it works and then compile it to ARM64 or ARM64EC if you use
components that have no native ARM64 versions.  
